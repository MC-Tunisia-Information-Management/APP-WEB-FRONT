    ...
    <>
      ...
      <section className="networktracker">
        ...
        <div className="networktracker-content-container">
          <a
            href="https://docs.google.com/spreadsheets/d/1flgEi9EyQl6cHoZk87KrKcmg6owssrolGR2HLMHzbIo/edit#gid=74829231"
            target="_blank"
          ...
          <a
            href="https://docs.google.com/spreadsheets/d/13_DoZK7DHOPGQvLwDcultqorlOuQO8lF1AQ_ywwKZpc/edit#gid=1234857507"
            target="_blank"
            className="networktracker-card"
          >
          ...
          <a
            href="https://docs.google.com/spreadsheets/d/1vmkGkrrkEovxjpVpR9z16c4xTOX6nAqHgn2aDC7WuN0/edit#gid=462857284"
            target="_blank"
            className="networktracker-card"
          >
          ...
          <a
            href="https://docs.google.com/spreadsheets/d/182xauomWs5YFsSFiSmvQY9iSWMx7PSnvCIBKhiCk0hI/edit#gid=699511709"
            target="_blank"
            className="networktracker-card"
          >
          ...
          <a
            href="https://docs.google.com/presentation/d/1pjM__MOhb3SdHGBlYPUAw06GoXdM8M-AqGMiiV-0GEk/edit#slide=id.g2773f8dd6e6_1_96"
            target="_blank"
            className="networktracker-card"
          >
